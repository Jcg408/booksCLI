...
3. () Error handling API call
4. () Explanation of lack of test
5. () How would application need to change if you wanted it to be served as a web app or mobile app? Description.
